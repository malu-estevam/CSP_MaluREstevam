...
grocereies = float(input("What is the cost of your groceries\n"))
...
# Tell user category spending amount and percent for savings ("You spend $XX.XX on transportation and that is 10% of your income")